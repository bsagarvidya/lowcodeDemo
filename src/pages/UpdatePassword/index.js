        ...
        <Column className="flex flex-col items-center justify-start sm:mt-[37px] md:mt-[48px] mt-[70px] w-[100%]">
          <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-start justify-between max-w-[1291px] ml-[auto] mr-[auto] sm:mx-[0] sm:pl-[15px] sm:pr-[15px] sm:px-[0] w-[100%]">
            <Column className="flex flex-col justify-start sm:mx-[0] sm:px-[0] sm:w-[100%] w-[51%]">
              ...
              <Text
                className="font-normal leading-[35.00px] md:leading-[normal] sm:leading-[normal] mt-[120px] sm:mt-[63px] md:mt-[82px] sm:mx-[0] not-italic text-black_900_87 tracking-ls05 md:tracking-ls1 sm:tracking-ls1 sm:w-[100%] w-[88%]"
                as="h6"
                variant="h6"
              >
            ...
            <Column className="bg-white_A700 border border-bluegray_900 border-solid flex flex-col items-center justify-start sm:mx-[0] sm:p-[15px] md:p-[35px] p-[51px] sm:w-[100%] w-[41%]">
              <Column className="flex flex-col items-center justify-start mb-[3px] sm:mx-[0] sm:px-[0] rounded-radius10 sm:w-[100%] w-[94%]">
                <Text
                ...
                <Column className="flex flex-col justify-start sm:mt-[31px] md:mt-[41px] mt-[60px] w-[100%]">
                  <Column className="flex flex-col font-poppins items-center justify-start pt-[3px] rounded-radius10 w-[100%]">
          ...
          <footer className="mt-[130px] sm:mt-[69px] md:mt-[89px] w-[100%]">
